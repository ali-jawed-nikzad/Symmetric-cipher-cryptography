...
class TwoSENew(object):
    ...
    def Encrypt(self):
        ...
        ConvPlainT = self.ConvertingPlainText(plaintext)
        ...
        for i in range(0, len(ConvPlainT)):
            firstletter = []
            secondletter = []

            firstletter.extend(self.findIndex(Matrix1, ConvPlainT[i][0]))
            secondletter.extend(self.findIndex(Matrix2, ConvPlainT[i][1]))

            if firstletter[0] != secondletter[0]:
                cipherText += Matrix2[firstletter[0]][secondletter[1]] + Matrix1[secondletter[0]][firstletter[1]]


            elif firstletter[0] == secondletter[0]:
                cipherText += Matrix2[secondletter[0]][secondletter[1]] + Matrix1[firstletter[0]][firstletter[1]]
...
"QPushButton:hover {background-color: #006400}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("img/End.jpeg")) # Backg.png
