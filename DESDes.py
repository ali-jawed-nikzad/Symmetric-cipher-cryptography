...
class DESDecr(object):
    def Decrypt(self):
        ...
        rkb_rev = rkb[::-1]
        rk_rev = rk[::-1]
        text = DESENCDEC.bin2hex(DESENCDEC.encrypt(Ciphertext, rkb_rev, rk_rev))
    ...
    def setupUi(self, Dialog):
        ...
        self.decryptbutton.setGeometry(QtCore.QRect(300, 300, 111, 41))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.key.setPlaceholderText(_translate("Dialog", "Enter the key (more than 16 char\'s"))
        self.Ciphertext.setPlaceholderText(_translate("Dialog", "Enter the Ciphertext: (More than 16 char\'s)"))
