...
class CaesarCipher(object):
    ...
    def Encrypt(self):
        ...
        for c in Plaintext:
            ...
            c_new = chr(c_shifted)
            encrypted += c_new
        self.ciphertext.setText(encrypted)
    ...
    def setupUi(self, Dialog):
        ...
        self.FirstKey.setGeometry(QtCore.QRect(110, 210, 201, 41))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.FirstKey.setPlaceholderText(_translate("Dialog", "Enter the Key number"))
